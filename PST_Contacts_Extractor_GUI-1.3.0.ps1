    ...
    try {
        ...
        try {
            if ($chkManualVerify.Checked) {
                # Manual: pick folder via Outlook and export only that folder to $csvPath
                ...
                # Automatic: run existing function
                ...
                foreach ($o in $output) {
                    if ($o -is [System.Management.Automation.ErrorRecord]) {
                        ...
                        Write-Log -Message $o.MessageData
                    } else {
...
$chkManualVerify.Anchor = 'Bottom,Left'
$chkManualVerify.Location = New-Object System.Drawing.Point(($btnRun.Left - 340), $btnRun.Top + 5))
$Form.Controls.Add($chkManualVerify)
# --- End checkbox ---
.ShowDialog()
# ==================== PST Folder Browser (Outlook COM API) ====================
...
$chkManualVerify.AutoSize = $true
$chkManualVerify.Anchor = 'Bottom,Left'
$chkManualVerify.Location = New-Object System.Drawing.Point(20, ($Form.ClientSize.Height - 50))
$Form.Controls.Add($chkManualVerify)
# --- End checkbox ---
.ShowDialog()
