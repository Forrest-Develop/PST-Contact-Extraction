...
# --- Safe icon load (works in ps2exe + plain script) ---
try {
    # Get script/exe directory reliably
    ...
    if (Test-Path -LiteralPath $icoPath) {
        ...
        Write-Host "Warning: app.ico not found at $icoPath"
    }
}
catch {
    Write-Host "Failed to load app.ico: $($_.Exception.Message)"
}
